...
CREATE TABLE IF NOT EXISTS message_to_user (
    ...
    primary_recipients             BINARY  COMMENT 'Serialized list of primary recipients. Column name is "to" in original MySQL schema, but renamed here to avoid reserved keyword issues.',
