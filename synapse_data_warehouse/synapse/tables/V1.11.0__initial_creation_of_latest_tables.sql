...
CREATE TABLE TABLE IF NOT EXISTS CERTIFIEDQUIZ_LATEST AS
WITH CQQ_RANKED AS (
    SELECT
        *,
        ROW_NUMBER() OVER (
...
CREATE TABLE TABLE IF NOT EXISTS USERPROFILE_LATEST AS WITH
RANKED_NODES AS (
    SELECT
        *,
        "row_number"()
...
CREATE OR REPLACE TABLE TEAM_LATEST AS WITH
RANKED_NODES AS (
    SELECT
        *,
        "row_number"()
...
-- filesnapshots
CREATE OR REPLACE TABLE FILE_LATEST AS WITH
RANKED_NODES AS (
    SELECT
        *,
        "row_number"()
...
CREATE OR REPLACE TABLE NODE_LATEST AS WITH
RANKED_NODES AS (
    SELECT
        *,
        "row_number"()
