...
ALTER TASK aclsnapshots_task SUSPEND;
...
ALTER TASK TEAMSNAPSHOTS_TASK SUSPEND;
...
ALTER TASK VERIFICATIONSUBMISSIONSNAPSHOTS_TASK SUSPEND;
...
ALTER TASK USERGROUPSNAPSHOTS_TASK SUSPEND;
