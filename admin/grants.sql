...
-- just the LIST_DOWNLOADERS* procedures. Effectively a no-op.
...
-- Grant USAGE on the LIST_DOWNLOADERS* procedures to developers
GRANT USAGE ON PROCEDURE SYNAPSE_DATA_WAREHOUSE.SYNAPSE.LIST_DOWNLOADERS(VARCHAR, VARCHAR)
...
-- Allow the proxy admins to apply the RDS_RAW PII masking policies to columns
-- on the dynamic tables they own
