...
-- GENIE_DEV database privileges
GRANT USAGE ON DATABASE GENIE_DEV
TO ROLE GENIE_ADMIN;
GRANT USAGE ON FUTURE SCHEMAS IN DATABASE GENIE_DEV
TO ROLE GENIE_ADMIN;
GRANT SELECT ON FUTURE TABLES IN DATABASE GENIE_DEV
TO ROLE GENIE_ADMIN;
