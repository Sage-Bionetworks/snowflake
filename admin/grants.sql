...
GRANT ROLE SYNAPSE_DATA_WAREHOUSE_ANALYST
	TO ROLE SAGE_CCKP_ADMIN;
-- Object-level analyst grants (Streamlit, dynamic tables)
GRANT USAGE ON STREAMLIT SAGE.CCKP.MC2_CENTER_METRICS
	TO ROLE SAGE_CCKP_ANALYST;
GRANT SELECT ON DYNAMIC TABLE SAGE.CCKP.MC2_PROJECTS
	TO ROLE SAGE_CCKP_ANALYST;
GRANT SELECT ON DYNAMIC TABLE SAGE.CCKP.MC2_NODES
	TO ROLE SAGE_CCKP_ANALYST;
