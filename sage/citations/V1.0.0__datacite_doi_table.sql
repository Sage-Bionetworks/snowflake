...
CREATE OR REPLACE TABLE synapse_doi_raw (
...
COMMENT ON TABLE synapse_doi_raw IS 'This table contains Synapse DOI data. DOI data is collected from three potential sources: ID_MINER, PUBMED_CRAWLER, and DATACITE.
