...
- `.github/skills/workon-streamlit-app/assets/fetch_streamlit_app.sh`
...
1. Use the bundled asset script directly from `.github/skills/workon-streamlit-app/assets/fetch_streamlit_app.sh`.
2. Resolve which Streamlit object to fetch (details below).
3. Run:

Use snippet asset:

- `.github/skills/workon-streamlit-app/assets/snippets/fetch_first_step.sh`
...
- `.github/skills/workon-streamlit-app/assets/snippets/list_streamlit_json.sh`
...
- `.github/skills/workon-streamlit-app/assets/snippets/streamlit_major_pin.yml`
...
- `.github/skills/workon-streamlit-app/assets/snippets/lookup_unqualified_tables.sql`
...
- `.github/skills/workon-streamlit-app/assets/snippets/local_sis_session_pattern.py`
...
- `.github/skills/workon-streamlit-app/assets/snippets/bootstrap_local_env.sh`

2. Run locally with `--local-dev` from the app directory in headless mode:

Use snippet asset:

- `.github/skills/workon-streamlit-app/assets/snippets/run_local_dev.sh`
...
- `.github/skills/workon-streamlit-app/assets/snippets/smoke_scan_logs.sh`
...
- `.github/skills/workon-streamlit-app/assets/snippets/smoke_scan_logs_fail_on_warning.sh`
...
- `.github/skills/workon-streamlit-app/assets/snippets/commit_message.txt`
